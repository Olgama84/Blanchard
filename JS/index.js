...
window.addEventListener('DOMContentLoaded', function() {
    document.querySelector('#burger').addEventListener('click', (e) =>{
        e.currentTarget.classList.toggle('btn-burger--active')
    })
...
document.addEventListener('click', function(e) {
    ...
    let menu_is_active = menu2.classList.contains('show2');
...
document.addEventListener('click', function(e) {
    ...
    let menu_is_active = menu3.classList.contains('show3');
...
document.addEventListener('click', function(e) {
    ...
    let menu_is_active = menu4.classList.contains('show4');
...
document.addEventListener('click', function(e) {
    ...
    let menu_is_active = menu5.classList.contains('show5');
